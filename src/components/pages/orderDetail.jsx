  ...
  const columns = [
    {
      ...
      maxWidth: "580px",
      cell: (row) => (
        <span className="plusJakara_medium text-[16px]">{row.title}</span>
      ),
    },
    {
      name: "Units",
    ...
    },
    {
      ...
      minWidth: "130px",
      cell: (row) => (
        <span className="plusJakara_medium">${row.totalPrice}</span>
      ),
    },
  ];
              ...
              <div className="flex gap-3 items-start w-full">
                <img
                  src={
                    ...
                    orderData?.to_id?.profilePicture
                  }
                  style={{
                    width: "120px",
                    height: "100px",
                ...
                <div className="flex flex-col w-full">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <span className="text_secondary2 whitespace-nowrap plusJakara_medium">
                  ...
                  {orderData?.assign_users?.map((item, i) => (
                    ...
                    >
                      <div className="flex gap-3 items-start">
                        <img
                          src={item?.user?.profilePicture || avatarman}
                          style={{
                            borderRadius: "50%",
                            objectFit: "cover",
                            width: "45px",
                        ...
                        <div className="flex flex-col items-start">
                          <h5 className="plusJakara_semibold mb-0 text_primary">
                            {item?.user?.name}
                          </h5>
                          ...
                          <h6
                            className={`${
                              orderData?.assign_users.length === 0
                                ? "text_secondary2"
                                : "text_primary"
                            } line-clamp-1 plusJakara_regular`}
                          >
                            Order Assigned to Employees
                          </h6>
                        </div>
                      </div>
                    ...
                    <div className="flex justify-between items-center w-full">
                      <div className="flex gap-3 items-center">
                        ...
                        <div className="flex flex-col">
                          ...
                          >
                            Employees working on assigned order
                          </h6>
                        </div>
                      </div>
                      <IoIosCheckmarkCircle
                    ...
                    <div className="flex justify-between items-center w-full">
                      <div className="flex gap-3 items-center">
                        ...
                        <div className="flex flex-col">
                          ...
                          >
                            Employee has completed the Order
                          </h6>
                        </div>
                      </div>
                      <IoIosCheckmarkCircle
                        size={34}
                        className={`${
                          workInProgress ? "text_secondary2" : "text_primary"
                        }`}
                      />
                    </div>
                  </Col>
          ...
          {orderData?.estimate ? (
            ...
            <div className="flex flex-col">
              ...
              <div className="w-full flex flex-col gap-3 mb-4">
                <ProductTable
                  columns={columns}
                  data={orderData?.service?.features}
                />
                <div className="flex flex-col gap-2 items-end justify-end w-full">
                  <div className="flex w-full justify-end">
                    <div
                      ...
                      style={{ width: "250px" }}
                    >
                      <h6 className="text_secondary2 mb-0 plusJakara_semibold">
                        Sub Total{" "}
                      </h6>
                      <h6 className="text_black plusJakara_semibold whitespace-nowrap mb-0">
                        $
                        {orderData?.service?.features?.reduce(
                          (sum, feature) => sum + (feature.totalPrice || 0),
                          0
                        )}
                      </h6>
                  ...
                  <div className="flex w-full justify-end">
                    ...
                    >
                      <h6 className="text_secondary2 mb-0 plusJakara_semibold">
                        Discount ({orderData?.service?.dis_price || 0}%)
                      </h6>
                      <h6 className="text_black plusJakara_semibold whitespace-nowrap mb-0">
                        $
                        {(grandTotal *
                          parseInt(orderData?.service?.dis_price)) /
                          100}
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="flex mt-3 w-full justify-end">
                    <div
                      ...
                      style={{ width: "250px" }}
                    >
                      <h5 className="text_primary mb-0 plusJakara_semibold">
                        Total Price{" "}
                      </h5>
