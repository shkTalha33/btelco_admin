...
const PackageSection = () => {
  ...
  return (
    <>
      <Container
        fluid
        className=" py-4 bg_white my-3 border rounded-lg border-white w-full"
      >
        <h4
          className="poppins_medium mb-4 text-lg md:text-2xl"
          style={{ color: "#151D48" }}
        >
        ...
        >
          <div className="d-flex w-100 gap-x-5 flex-wrap flex-md-nowrap md:items-center justify-between">
            <div className="w-100 mb-3 gap-5">
              <Label>Status</Label>
              <Checkbox className="ml-3 my-3">Enable</Checkbox>
              <Checkbox className=" my-3">Disable</Checkbox>
            </div>
